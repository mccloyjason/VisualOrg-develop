...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProcessInstance.visibility'
        db.add_column(u'processes_processinstance', 'visibility',
                      self.gf('django.db.models.fields.CharField')(default='public', max_length=50),
                      keep_default=False)

        # Adding field 'ProcessInstance.organization'
        db.add_column(u'processes_processinstance', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='process_instances', to=orm['accounts.Organization']),
                      keep_default=False)

        # Adding field 'ProcessInstance.primary_organization'
        db.add_column(u'processes_processinstance', 'primary_organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='all_process_instances', to=orm['accounts.Organization']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProcessInstance.visibility'
        db.delete_column(u'processes_processinstance', 'visibility')

        # Deleting field 'ProcessInstance.organization'
        db.delete_column(u'processes_processinstance', 'organization_id')

        # Deleting field 'ProcessInstance.primary_organization'
        db.delete_column(u'processes_processinstance', 'primary_organization_id')
