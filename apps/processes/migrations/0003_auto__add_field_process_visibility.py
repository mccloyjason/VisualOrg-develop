...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Process.visibility'
        db.add_column(u'processes_process', 'visibility',
                      self.gf('django.db.models.fields.CharField')(default='public', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Process.visibility'
        db.delete_column(u'processes_process', 'visibility')
