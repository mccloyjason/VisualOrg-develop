...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field next_nodes on 'ProcessStep'
        m2m_table_name = db.shorten_name(u'processes_processstep_next_nodes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_processstep', models.ForeignKey(orm[u'processes.processstep'], null=False)),
            ('to_processstep', models.ForeignKey(orm[u'processes.processstep'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_processstep_id', 'to_processstep_id'])


    def backwards(self, orm):
        # Removing M2M table for field next_nodes on 'ProcessStep'
        db.delete_table(db.shorten_name(u'processes_processstep_next_nodes'))
