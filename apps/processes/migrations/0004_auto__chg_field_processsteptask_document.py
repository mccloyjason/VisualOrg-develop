...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProcessStepTask.document'
        db.alter_column(u'processes_processsteptask', 'document_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['documents.Document'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProcessStepTask.document'
        raise RuntimeError("Cannot reverse this migration. 'ProcessStepTask.document' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ProcessStepTask.document'
        db.alter_column(u'processes_processsteptask', 'document_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['documents.Document']))
