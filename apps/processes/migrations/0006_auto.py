...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field shared_with on 'ProcessInstance'
        m2m_table_name = db.shorten_name(u'processes_processinstance_shared_with')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('processinstance', models.ForeignKey(orm[u'processes.processinstance'], null=False)),
            ('user', models.ForeignKey(orm[u'accounts.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['processinstance_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field shared_with on 'ProcessInstance'
        db.delete_table(db.shorten_name(u'processes_processinstance_shared_with'))
