...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserStatistic.organization'
        db.add_column(u'accounts_userstatistic', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['accounts.Organization']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserStatistic.organization'
        db.delete_column(u'accounts_userstatistic', 'organization_id')
