...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrganizationStatistic'
        db.create_table(u'accounts_organizationstatistic', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Organization'])),
            ('num_roles', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('num_roles_filled', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('num_roles_unfilled', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('num_external_roles', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('num_teams', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('num_workgroups', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('num_livedocs_active', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('num_livedocs_completed', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('num_documents', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('percent_static_documents', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('average_time_questions_open', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('num_questions', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('num_answers', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'accounts', ['OrganizationStatistic'])

        # Adding unique constraint on 'OrganizationStatistic', fields ['date', 'organization']
        db.create_unique(u'accounts_organizationstatistic', ['date', 'organization_id'])

        # Adding model 'UserStatistic'
        db.create_table(u'accounts_userstatistic', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User'])),
            ('num_processes_developed', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('num_processes_initiated', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'accounts', ['UserStatistic'])

        # Adding unique constraint on 'UserStatistic', fields ['date', 'user']
        db.create_unique(u'accounts_userstatistic', ['date', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserStatistic', fields ['date', 'user']
        db.delete_unique(u'accounts_userstatistic', ['date', 'user_id'])

        # Removing unique constraint on 'OrganizationStatistic', fields ['date', 'organization']
        db.delete_unique(u'accounts_organizationstatistic', ['date', 'organization_id'])

        # Deleting model 'OrganizationStatistic'
        db.delete_table(u'accounts_organizationstatistic')

        # Deleting model 'UserStatistic'
        db.delete_table(u'accounts_userstatistic')
    ...
    models = {
        ...
        u'accounts.organizationstatistic': {
            ...
            'average_time_questions_open': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'num_answers': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'num_documents': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'num_external_roles': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'num_livedocs_active': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'num_livedocs_completed': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'num_questions': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'num_roles': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'num_roles_filled': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'num_roles_unfilled': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'num_teams': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'num_workgroups': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.Organization']"}),
            'percent_static_documents': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        u'accounts.role': {
        ...
        u'accounts.userstatistic': {
            ...
            'date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'num_processes_developed': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'num_processes_initiated': ('django.db.models.fields.PositiveIntegerField', [], {}),
