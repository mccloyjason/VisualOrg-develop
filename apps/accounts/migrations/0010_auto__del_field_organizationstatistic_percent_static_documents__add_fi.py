...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OrganizationStatistic.percent_static_documents'
        db.delete_column(u'accounts_organizationstatistic', 'percent_static_documents')

        # Adding field 'OrganizationStatistic.num_documents_static'
        db.add_column(u'accounts_organizationstatistic', 'num_documents_static',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'OrganizationStatistic.percent_static_documents'
        raise RuntimeError("Cannot reverse this migration. 'OrganizationStatistic.percent_static_documents' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'OrganizationStatistic.percent_static_documents'
        db.add_column(u'accounts_organizationstatistic', 'percent_static_documents',
                      self.gf('django.db.models.fields.PositiveIntegerField')(),
                      keep_default=False)

        # Deleting field 'OrganizationStatistic.num_documents_static'
        db.delete_column(u'accounts_organizationstatistic', 'num_documents_static')
