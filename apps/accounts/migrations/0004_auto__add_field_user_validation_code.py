...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.validation_code'
        db.add_column(u'accounts_user', 'validation_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.validation_code'
        db.delete_column(u'accounts_user', 'validation_code')
