...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Role.lft'
        db.add_column(u'accounts_role', u'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Role.rght'
        db.add_column(u'accounts_role', u'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Role.tree_id'
        db.add_column(u'accounts_role', u'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Role.level'
        db.add_column(u'accounts_role', u'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)


        # Changing field 'Role.parent'
        db.alter_column(u'accounts_role', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['accounts.Role']))

    def backwards(self, orm):
        # Deleting field 'Role.lft'
        db.delete_column(u'accounts_role', u'lft')

        # Deleting field 'Role.rght'
        db.delete_column(u'accounts_role', u'rght')

        # Deleting field 'Role.tree_id'
        db.delete_column(u'accounts_role', u'tree_id')

        # Deleting field 'Role.level'
        db.delete_column(u'accounts_role', u'level')


        # Changing field 'Role.parent'
        db.alter_column(u'accounts_role', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.Role']))
