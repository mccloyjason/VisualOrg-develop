...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.lft'
        db.add_column(u'accounts_organization', u'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Organization.rght'
        db.add_column(u'accounts_organization', u'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Organization.tree_id'
        db.add_column(u'accounts_organization', u'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Organization.level'
        db.add_column(u'accounts_organization', u'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)


        # Changing field 'Organization.parent'
        db.alter_column(u'accounts_organization', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['accounts.Organization']))

    def backwards(self, orm):
        # Deleting field 'Organization.lft'
        db.delete_column(u'accounts_organization', u'lft')

        # Deleting field 'Organization.rght'
        db.delete_column(u'accounts_organization', u'rght')

        # Deleting field 'Organization.tree_id'
        db.delete_column(u'accounts_organization', u'tree_id')

        # Deleting field 'Organization.level'
        db.delete_column(u'accounts_organization', u'level')


        # Changing field 'Organization.parent'
        db.alter_column(u'accounts_organization', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.Organization']))
